...
All clients expose the same surface used by the agents:
...
from arpa.models.openrouter_client import OpenRouterClient, OpenRouterError
from arpa.models.nvidia_client import NvidiaClient, NvidiaError
from arpa.models.groq_client import GroqClient, GroqError
...
def get_llm_client(
    ...
    *,
    ...
    backend: "ollama", "gemini", "openrouter", "nvidia", or "groq". Falls back to settings.llm_backend.
    """
    ...
    raise ValueError(f"Unknown LLM backend: {backend!r} (expected 'ollama', 'gemini', 'openrouter', 'nvidia', or 'groq')")
